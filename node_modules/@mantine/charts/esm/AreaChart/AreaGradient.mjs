...
//#region packages/@mantine/charts/src/AreaChart/AreaGradient.tsx
function AreaGradient({ color, id, withGradient, fillOpacity }) {
	return /* @__PURE__ */ jsx(Fragment, { children: withGradient ? /* @__PURE__ */ jsxs("linearGradient", {
		id,
		x1: "0",
		y1: "0",
		x2: "0",
...
//# sourceMappingURL=AreaGradient.mjs.map